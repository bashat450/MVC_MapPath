...
namespace CrudMap.Controllers
{
    public class TeachersController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Create(AllModel createModel, HttpPostedFileBase imageFile)
        {
            try
            {
        ...
        [HttpPost]
        public ActionResult Edit(int id, AllModel editModel, HttpPostedFileBase imageFile)
        {
            try
            {
                if (imageFile != null && imageFile.ContentLength > 0)
